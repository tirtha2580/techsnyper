  ...
  return (
    ...
    <div
         ...
         >
           ...
           >
             ...
             >
               ...
               >
                 <span style={{ marginLeft: "10px" }}>Pressure Accessories</span> 
               </Typography>
             </Grid>
         ...
         >
           ...
           >
             <span style={{ borderBottom: "2px solid #F8B400" }}>P</span>ressure Accessories
           </Typography>
         </div>
...
<br />
          <Grid container style={{padding:'10px'}}>
               ...
               <Grid item xs={12} md={8} style={{display:'flex',alignItems:'center',justifyContent:'center'}}>
                     <Typography style={{fontSize:'16px,',color:'#000',textAlign:'center',fontFamily: "Jost, sans-serif",}}>  Our Manifolds are a perfect complement to Pressure transmitters family in different configurations to different process applications.</Typography>
               </Grid>
               <Grid item xs={12}md={2}></Grid>
               </Grid>
             ...
             <Grid container style={{background:'#F1F1EE'}}>
               ...
               <Grid item xs={12}md={2}></Grid>
                    ...
                    <div style={{background:'#F1F1EE',height:'5vh'}}>
